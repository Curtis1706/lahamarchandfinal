      ...
      <div className="bg-slate-700 text-white px-4 lg:px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <span className="text-sm text-slate-300">Tableau de bord - Notifications</span>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {notifications.map((notification, index) => (
                  <tr key={index} className="hover:bg-gray-50">
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{notification.code}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{notification.titre}</td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <Badge
                        className={
                          notification.statut === "Actif" ? "bg-green-100 text-green-800" : "bg-gray-100 text-gray-800"
                        }
                      >
                        {notification.statut}
                      </Badge>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{notification.dateCreation}</td>
