    ...
    <div className="bg-gradient-to-br from-slate-50 to-gray-100">
      ...
      <div className="p-6 -mt-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow p-6 border-t-2 border-green-500">
            <div className="flex items-center justify-between">
              <div>
          ...
          <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow p-6 border-t-2 border-red-500">
            <div className="flex items-center justify-between">
              <div>
          ...
          <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow p-6 border-t-2 border-slate-500">
            <div className="flex items-center justify-between">
              <div>
          ...
          <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow p-6 border-t-2 border-purple-500">
            <div className="flex items-center justify-between">
              <div>
