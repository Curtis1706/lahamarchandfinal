...
export default function ConcepteurRetraitsPage() {
  ...
  const loadWithdrawals = async () => {
    try {
      setLoading(true)
      // Utiliser la même API que les auteurs car concepteurs reçoivent aussi des royalties
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-bold">Mes Ristournes & Retraits</h1>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-sm font-medium text-gray-600">Total des ristournes</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-sm font-medium text-gray-600">Ristournes approuvées</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      <Card className="border-blue-200 bg-blue-50">
        <CardContent className="pt-6">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="font-medium text-blue-900">Ristournes Concepteur</h4>
              <p className="text-sm text-blue-700 mt-1">
                En tant que concepteur, vous recevez des ristournes sur les œuvres créées dans le cadre de vos projets validés.
                Ces ristournes sont calculées automatiquement lors des ventes et doivent être approuvées par le PDG avant retrait.
              </p>
            </div>
          </div>
        </CardContent>
